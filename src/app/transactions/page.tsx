...
export default function TransactionsPage() {
  ...
  const totalBuyAmount = mockTransactions
    .filter(t => t.type === 'buy')
    .reduce((sum, t) => sum + t.amount, 0)
  const totalSellAmount = mockTransactions
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          {isProfit && (
            <div className={`flex items-center gap-1 text-sm font-medium ${
              ...
              {value >= 0 ? '+' : ''}
              <AnimatedPercentage value={value / 1000} />
            </div>
          )}
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <div className="flex items-center gap-2 mb-1">
              ...
              <Badge variant="outline" className="text-xs">{transaction.symbol}</Badge>
        ...
        <div className="flex items-center gap-4">
          <div className="text-right">
            <div className="font-medium">
              <AnimatedCurrency value={transaction.amount} />
            </div>
            {transaction.profit !== undefined && (
              <div className={`text-sm ${
                ...
                ({transaction.profit >= 0 ? '+' : ''}
                <AnimatedPercentage value={transaction.profitRate || 0} showSign={false} />)
              </div>
            )}
          </div>
